...
class StreamForm extends React.Component {
  ...
  //We don't want to have StreamForm how to handle submission
  //Instead, StreamForm should attempt to call a callback that's passed down from props, from some parent
  //this.props.onSubmit - now we expect parent to pass down a callback called "onSubmit"
  onSubmit = (formValues) =>{
